...
<head>
	...
	$(document).ready(function() {
		...
		$("#leave_form").on('submit',(function(e) {
			...
			} else if($("#upload-msg").css("display") == "none" && $("#checkbox2").is(":checked")){
			...
			<div style="margin-left: 5%;" class="modal-dialog">
			  ...
			  <div class="modal-content">
				<div class="modal-header">
				  ...
				  <h4 style="color:blue;">
				  <span class="glyphicon glyphicon-list-alt"></span> Re-submission : Online Hostel Leaving Form <span class="badge"> Form No. 18 </span> </h4>
				</div>
				...
				<div class="modal-body">
				  <form role="form" id="leave_form" method="post">
					...
					<div class="form-group col-sm-6">
					  ...
					  <input type="text" class="form-control" id="stud_phone" maxlength="15" placeholder="Enter your phone number" value="<?php echo $_SESSION['phone'] ?>" >
					</div>
					...
					<div class="form-group col-sm-6">
						<label for="stud_checkbox1">
							<label class="checkbox-inline text-info"><input id="checkbox1" type="checkbox" value="" <?php if ($_SESSION['checkbox1'] == "true") echo "checked"; ?>
							><strong>Project related leave</strong></label>
						</label>
					</div>
					
					<div class="form-group col-sm-6">
						<label for="stud_checkbox2">
							<label class="checkbox-inline text-info"><input id="checkbox2" type="checkbox" value="" <?php if ($_SESSION['checkbox2'] == "true") echo "checked"; ?>
							><strong>M. Tech/Ph. D student</strong></label>
						</label>
					</div>
					
					<div class="form-group">
					  <label for="stud_purpose"><span class="glyphicon glyphicon-comment"></span> Purpose of hostel Leave (Please specify) </label>
					  <textarea style="resize: none;" maxlength="200" type="text" class="form-control" id="stud_purpose" placeholder="Purpose of hostel Leave"required><?php echo $_SESSION['purpose'] ?> </textarea>
					</div>
					...
					<div id="checkbox2_div">
						...
						<div class="form-group">
						  ...
						  <input type="text" maxlength="30" class="form-control" id="stud_guide_name" value="<?php echo $_SESSION['guide_name'] ?>" 
						  placeholder="Name of Supervisor/Guide in case of M. Tech/Ph. D student">
						</div>
					...
					<div class="form-group col-sm-6">
					  ...
					  <input type="text" class="form-control" maxlength="60" id="stud_date_of_dep" placeholder="Date of Departure" value="<?php echo $_SESSION['date_of_dep'] ?>" required>
					</div>
					
					<div class="form-group col-sm-6">
					  <label for="stud_date_of_arr"><span class="glyphicon glyphicon-calendar"></span> Date of Arrival</label>
					  <input type="text" class="form-control" maxlength="60" id="stud_date_of_arr" placeholder="Date of Arrival" value="<?php echo $_SESSION['date_of_arr'] ?>" required>
					</div>
					...
					<div class="form-group col-sm-6">
						...
						<div class="btn-group">
							<div class="btn-group">
								<button type="button" id="hr1" class="btn btn-primary"><?php echo explode(":",$_SESSION['time_of_dep'])[0]; ?></button>
							...
							<div class="btn-group">
								<button type="button" id="min1" class="btn btn-primary"><?php echo explode(":",$_SESSION['time_of_dep'])[1]; ?></button>
								<button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
									<span class="caret"></span>
								</button>
								<ul class="dropdown-menu" role="menu">
							...
							<div class="btn-group">
								<button type="button" id="am1" class="btn btn-primary"><?php echo explode(":",$_SESSION['time_of_dep'])[2]; ?></button>
								<button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
									<span class="caret"></span>
								</button>
								<ul class="dropdown-menu" role="menu">
					...
					<div class="form-group col-sm-6">
						...
						<div class="btn-group">
							<div class="btn-group">
								<button type="button" id="hr2" class="btn btn-primary"><?php echo explode(":",$_SESSION['time_of_arr'])[0]; ?></button>
								<button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
									<span class="caret"></span>
								</button>
								<ul class="dropdown-menu" role="menu">
							...
							<div class="btn-group">
								<button type="button" id="min2" class="btn btn-primary"><?php echo explode(":",$_SESSION['time_of_arr'])[1]; ?></button>
								<button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
									<span class="caret"></span>
								</button>
								<ul class="dropdown-menu" role="menu">
							...
							<div class="btn-group">
								<button type="button" id="am2" class="btn btn-primary"><?php echo explode(":",$_SESSION['time_of_arr'])[2]; ?></button>
								<button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
									<span class="caret"></span>
								</button>
								<ul class="dropdown-menu" role="menu">
					...
					<div id="checkbox1_div">
						...
						<div class="form-group">
						  ...
						  <input type="text" maxlength="30" class="form-control" id="ppi_name"  value="<?php echo $_SESSION['ppi_name'] ?>" 
						  placeholder="Name of Principle project investigator">
						</div>
						
						<div class="form-group col-sm-6">
						  <label for="project_code"><span class="glyphicon glyphicon-barcode"></span> Project Code</label>
						  <input type="text" maxlength="30" class="form-control" id="project_code"  value="<?php echo $_SESSION['project_code'] ?>"  placeholder="Project Code">
						</div>
						
						<div class="form-group col-sm-6">
						  <label for="contract_up_to"><span class="glyphicon glyphicon-calendar"></span> My contract up to</label>
						  <input type="text" class="form-control" maxlength="30" id="contract_up_to" value="<?php echo $_SESSION['contract_up_to'] ?>"  placeholder="My contract up to">
						</div>
					...
					<div class="form-group">
					  ...
					  <textarea style="resize: none;" maxlength="200" type="text" class="form-control" id="stud_address" placeholder="Enter your home address"><?php echo $_SESSION['address'] ?> </textarea>
					</div>
					...
					<div class="form-group">
					  ...
					  <textarea style="resize: none;" maxlength="200" type="text" class="form-control" id="stud_em_address" placeholder="Contact addresses during Leave period"><?php echo $_SESSION['em_address'] ?> </textarea>
					</div>
